...
public class UserDao {
	...
	/*
	 * // 인스턴스 변수를 사용하도록 수정 public User get(String id) throws
	 * ClassNotFoundException, SQLException{ this.c =
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * SQLException{ UserDao dao = new UserDao();
			 * 
			 * User user = new User(); user.setId("whiteship"); user.setName("백기선");
