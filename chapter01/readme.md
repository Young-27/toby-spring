...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/f205c91a-60a2-49a5-999b-8c113a3d4532/Untitled.png)

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7eda75dc-3443-4f55-8718-456411f6ab0c/Untitled.png)
...
- ==⇒ **낮은 결합도와 높은 응집도**를 가진 깔끔한 코드를 만들었다.
...
서버에서 사용되는 서비스 오브젝트로서의 장점을 살릴 수 있는 싱글톤을 사용하면서도 **싱글톤 패턴의 단점을 극복하도록 설계된 컨테이너**를 활용하는 방법에 대해 알아봤다. **(싱글톤 레지스토리)**
...
- 의존 오브젝트를 주입할 때 **생성자**를 이용하는 방법과 **수정자 메소드**를 이용하는 방법을 알아봤다. **(생성자 주입과 수정자 주입)**
